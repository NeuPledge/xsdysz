...
public class StudentServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetStudentPage() {
       ...
       // 测试 gradeId 不匹配
       studentMapper.insert(cloneIgnoreId(dbStudent, o -> o.setGradeId(null)));
       // 测试 gradeName 不匹配
       studentMapper.insert(cloneIgnoreId(dbStudent, o -> o.setGradeName(null)));
       // 测试 collegeId 不匹配
       studentMapper.insert(cloneIgnoreId(dbStudent, o -> o.setCollegeId(null)));
       // 测试 createTime 不匹配
